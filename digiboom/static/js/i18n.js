(function () {
  ...
  var LANG_META = {
    az: { label: 'AZ', name: 'Azərbaycan', flag: '/static/images/flags/flag-az.webp' },
    en: { label: 'EN', name: 'English', flag: '/static/images/flags/flag-en.webp' },
    ru: { label: 'RU', name: 'Русский', flag: '/static/images/flags/flag-ru.webp' }
  };
